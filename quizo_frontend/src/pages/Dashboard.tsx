...
import { Loader2, Pencil, Trash, Book, Search, Filter } from "lucide-react";
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center mb-6">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <h2 className="text-3xl font-bold text-gray-800">Quiz Dashboard</h2>
            </div>
            <motion.div
            ...
            <motion.div
              ...
              >
                <Button
                  ...
                  variant="outline"
                  className="px-6 py-2 rounded-lg flex items-center gap-2 text-gray-700 hover:text-red-600 hover:border-red-600"
                >
